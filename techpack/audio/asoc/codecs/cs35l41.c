...
/* Huaqin add for real-time ears back by xudayi at 2018/07/27 start */
static const DECLARE_TLV_DB_RANGE(dig_vol_tlv,
		0, 0, TLV_DB_SCALE_ITEM(TLV_DB_GAIN_MUTE, 0, 1),
		1, 913, TLV_DB_SCALE_ITEM(-10200, 25, 0));
/* Huaqin add for real-time ears back by xudayi at 2018/07/27 end */
...
/* Huaqin add for solve pa disable not go sleep by xudayi at 2018/08/31 start */
...
/* Huaqin add for solve pa disable not go sleep by xudayi at 2018/08/31 end */
...
static int cs35l41_otp_unpack(void *data)
{
	...
	#ifdef  CONFIG_SND_SOC_CIRRUS_PA_SPI
...
/* Huaqin add for solve pa disable not go sleep by xudayi at 2018/08/31 start */
	if (status[1] & (1 << CS35L41_CSPL_MBOX_CMD_FW_SHIFT)) {
		...
		dev_crit(cs35l41->dev, "Clear timeout flag \n");
	}
/* Huaqin add for solve pa disable not go sleep by xudayi at 2018/08/31 end */
...
/* Huaqin add for slove pa disable not go sleep by xudayi at 2018/08/31 start */
...
/* Huaqin add for slove pa disable not go sleep by xudayi at 2018/08/31 end */
		break;
...
static int cs35l41_dsp_init(struct cs35l41_private *cs35l41)
{
	...
	/*Huaqin add for spk Rcv protection by xudayi at 2018-07-02 start*/
	dsp->suffix = "";
	/*Huaqin add for spk Rcv protection by xudayi at 2018-07-02 end*/
				...
				struct cs35l41_platform_data *pdata)
{
	...
	*/
	...
	/* Huaqin add for solve disable pa not go sleep by xudayi at 2018/08/31 start */
		regmap_write(cs35l41->regmap, CS35L41_BSTCVRT_DCM_CTRL, 0x51);
	/* Huaqin add for solve disable pa not go sleep by xudayi at 2018/08/31 end */
		break;
