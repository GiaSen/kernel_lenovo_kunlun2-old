...
#define WM_ADSP_FW_SPK_PROT_RCV 11
#define WM_ADSP_FW_SPK_PROT_CAL 12
#define WM_ADSP_FW_SPK_PROT_CALRCV 13
...
static const char *wm_adsp_fw_text[WM_ADSP_NUM_FW] = {
	...
	[WM_ADSP_FW_SPK_PROT] = "Protection SPK",
	[WM_ADSP_FW_MISC] =     "Misc",
	[WM_ADSP_FW_SPK_PROT_RCV] = "Protection RCV",
	[WM_ADSP_FW_SPK_PROT_CAL] ="Protection CAL",
	[WM_ADSP_FW_SPK_PROT_CALRCV] ="Protection CALRCV",
...
static struct wm_adsp_fw_defs wm_adsp_fw[WM_ADSP_NUM_FW] = {
	...
	[WM_ADSP_FW_SPK_PROT] = { .file = "spk-prot",.binfile = "spk-prot"  },
	[WM_ADSP_FW_MISC] =     { .file = "misc" },
       [WM_ADSP_FW_SPK_PROT_RCV] = { .file =  "spk-prot",.binfile ="rcv-prot"  },
       [WM_ADSP_FW_SPK_PROT_CAL] = { .file =  "cali-prot",.binfile = "cali-spk"  },
       [WM_ADSP_FW_SPK_PROT_CALRCV] = { .file =  "cali-prot",.binfile = "cali-rcv"  },
};
