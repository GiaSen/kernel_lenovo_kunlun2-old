...
#ifdef CONFIG_TOUCHSCREEN_GOODIX_GTX8_SECURETOUCH
#define GOODIX_SECURE_TOUCH 1
#endif
...
struct goodix_ts_coords {
	int id;
	int slideRes;
	unsigned int x, y, w, p,length,width;
};
...
struct goodix_ts_hw_ops {
	...
	int (*avdd_en)(struct goodix_ts_device *dev, int enable);
};
